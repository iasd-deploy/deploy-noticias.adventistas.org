                                ...
                                <figure class="figure m-xl-0 w-100">
                                    ...
                                    <figcaption class="figure-caption position-absolute w-100 p-3 rounded-bottom">
                                        <?php if (! empty(getPostFormat($item))) : ?>
                                            <span class="pa-tag rounded-1 text-uppercase mb-2 d-table-cell px-2"><?php echo e(getPostFormat($item)->name); ?></span>
                                        <?php endif; ?>
...
<?php endif; ?><?php /**PATH /Users/eli/Dropbox (ComunicaDSA)/projects/deploy-noticias.adventistas.org/app/es/wp-content/themes/pa-theme-noticias/template-parts/featured-posts.blade.php ENDPATH**/ ?>
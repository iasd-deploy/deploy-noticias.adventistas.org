...
//	$sql = "SELECT * FROM wp_postmeta where post_id = 30037 AND meta_key = 'amazonS3_info'";
	...
	foreach ($dbh->query($sql) as $row) {
		...
		//echo $value;
		echo "<br>";
		$update = "UPDATE wp_postmeta SET meta_value = '". $value ."' where post_id = $post_id and meta_key = 'amazonS3_info'";
		echo $update;
		echo "<br/><br/>";

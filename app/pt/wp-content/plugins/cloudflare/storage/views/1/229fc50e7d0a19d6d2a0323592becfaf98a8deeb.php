<header class="mb-4">
    ...
    <?php if(!empty($format = getPostFormat(get_the_ID())) && $format->slug != 'artigo' && is_singular('post')): ?>        
        <div class="pa-post-meta mb-2"><?php echo e(__('By', 'iasd')); ?> 
            <span><?php echo e(getCurrentAuthor(get_the_ID())); ?></span>
            <?php if($region = getPostRegion(get_the_ID())): ?>
                <em class="pa-pipe">|</em>
                <span><i class="fas fa-map-marker-alt me-2" aria-hidden="true"></i> <?php echo e($region->name); ?></span>
            <?php endif; ?>
        </div>
    <?php endif; ?>
...
<?php /**PATH /Users/isaltino/Git/deploy-noticias.adventistas.org/app/pt/wp-content/themes/pa-theme-noticias/template-parts/single/header.blade.php ENDPATH**/ ?>
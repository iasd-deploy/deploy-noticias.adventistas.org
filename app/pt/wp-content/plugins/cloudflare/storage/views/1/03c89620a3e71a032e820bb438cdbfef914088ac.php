<?php if (! empty($id)) : ?>
    ...
    <div class="pa-card-author d-flex flex-column flex-lg-row">
        <div class="col-auto align-items-center d-flex flex-column mb-4 mb-lg-0">
            ...
            <h4 class="pa-card-author__title fw-bold mt-3 pt-1 mt-lg-4 pt-lg-0 mb-0"><?php echo e($data->display_name); ?></h4>
        </div>

        <div class="pa-card-author__data col text-center text-lg-start d-flex flex-column">
            <?php if (! empty($column_name)) : ?>
                <h3 class="pa-card-author__column-name fw-bold mb-2 order-2 order-lg-1"><?php echo $column_name; ?></h3>
            <?php endif; ?>

            <?php if (! empty($column_excerpt)) : ?>
                <p class="pa-card-author__column-excerpt mb-4 mb-lg-2 order-3 order-lg-2"><?php echo $column_excerpt; ?></p>
            <?php endif; ?>

            <?php if (! empty($description)) : ?>
                <p class="pa-card-author__description m-0 order-4 order-lg-3"><?php echo $description; ?></p>
            <?php endif; ?>

            <div class="pa-card-author__social order-1 order-lg-4 mb-4 m-lg-0 mt-lg-4">
                <?php if (! empty($facebook)) : ?>
                    <a href="<?php echo e($facebook); ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                <?php endif; ?>
                <?php if (! empty($twitter)) : ?>
                    <a href="<?php echo e($twitter); ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                <?php endif; ?>
                <?php if (! empty($instagram)) : ?>
                    <a href="<?php echo e($instagram); ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH /Users/eli/Dropbox (ComunicaDSA)/projects/deploy-noticias.adventistas.org/app/pt/wp-content/themes/pa-theme-noticias/components/cards/card-author.blade.php ENDPATH**/ ?>